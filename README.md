...
- **Tools & Technologies:** RabbitMQ, BullMQ, Google Pub/Sub, Socket.IO, Docker, Kubernetes, AWS, CI/CD, NGINX, TypeORM, Ansible, Winston, Pino, Jest, FFMPEG
- **APIs & Architecture:** RESTful APIs, GraphQL, Apollo Server, Domain-Driven Design (DDD)
