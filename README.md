Six years in Node.js and TypeScript, mostly in the parts users never see: job queues, payment flows, real-time delivery, services talking to each other. I've built these across healthcare, insurance, and a proxy platform. I do a lot of work that only matters when something breaks: retry logic, distributed locks, and decoupling services so one failure doesn't cascade.
...
- **Frameworks:** Express.js, Nest.js, Adonis.js, Laravel
- **Databases:** MongoDB, PostgreSQL, MySQL, Redis
- **Tools & Technologies:** RabbitMQ, BullMQ, Google Pub/Sub, Socket.IO, Docker, Kubernetes, AWS, CI/CD, NGINX, TypeORM, Ansible, Winston, Pino, Jest
- **Architecture & Patterns:** Domain-Driven Design, Microservices, Event-Driven Systems, RESTful APIs, GraphQL, Distributed Locking, OOP
